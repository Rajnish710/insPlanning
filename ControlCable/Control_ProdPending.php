    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table class="table table-bordered">
            ...
            <tbody>
                <?php
                    $sql = "SELECT DISTINCT CAST(createdAt AS DATE) AS Date, planningNo, McNo FROM [PlanningSys].[control].[givenPlanning] order by planningNo DESC";
...
$.ajax({
type: "POST",
url: "getControl_prodPending.php",
dataType: "json",
data:{jobs:jobs},
...
$(document).ready(function(){
   ...
   // Get Pdf for machine planning
    $(document).on("click",".GetPdf",function(){
        ...
        // alert(planno);
        // alert(mc);
            window.open('http://103.53.72.188:5560/InsPlanning/ControlCable/insPlanPDF.php?mc='+mc+ '&planno='+planno, '_blank');
